...
algo05g :: Diagram B
algo05g = text "-0+ *" # fontSizeL 0.6 # fc black # translateX 0.8
         <> vertices
         <> edges
         <> line
         <> littleArrow
...
-- The edges
edges :: Diagram B
edges = atPoints midpoints (map edgelabel [("0+",1.4, 0.7, 0.6),  ("",1.4, 0.01, 0.01), ("", 0.01, 0.01, 0.01)])
...
line :: Diagram B
line = (fromVertices $ ((-2.07) ^&  (-1.2)) ~~  (1.285 ^&  2.1)) # lc cyan # lw veryThick
